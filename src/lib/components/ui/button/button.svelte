  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        ...
        outline:
          "border-border hover:bg-primary/10 hover:border-primary/40 hover:text-primary aria-expanded:bg-muted aria-expanded:text-foreground",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-primary/10 hover:text-primary aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
        ghost:
