...
>
  {#snippet children({ thumbItems })}
    <span
      ...
      class={cn(
        "bg-muted bg-muted relative grow overflow-hidden rounded-md data-horizontal:h-1 data-horizontal:w-full data-horizontal:w-full data-vertical:h-full data-vertical:h-full data-vertical:w-1",
      )}
    >
